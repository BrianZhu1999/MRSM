...
def MRSM_sample_1d_ISS(config, net, sde, y, transform, corrector, n_steps=5, alpha=1., beta=0.4, gamma=0.5, snr=0.128, std_y=None,
                T_prime_y=10, T_prime=0, overlap=1,
...
def generate_parallel_1d_ISS(config, net, sde, y, transform, corrector, n_steps=5, alpha=1., beta1=100., beta2=100, snr=0.128, std_y=None, gamma=1.e-2,
    ...
    with tqdm(range(ds)) as tqdm_setting:
        for i in range(ds):
            ...
            #print(x_pred.shape)
            x = rearrange(temp, '(b n) t c h -> b n t c h', n=b)
            x_mean = rearrange(temp_u if i < sde_start_step else temp_mean, 
...
def MRSM_sample_2d_ISS_ERA5(config, net, sde, y, transform, corrector, n_steps=5, alpha=1., beta=0.4, gamma=0.5, snr=0.128, std_y=None,
                                T_prime_y=10, T_prime=0, overlap=1,
                                eta=0.0,
...
def MRSM_sample_2d_ISS_2dsound(config, net, sde, y, transform, corrector, n_steps=5, alpha=1., beta=0.4, gamma=0.5, snr=0.128, std_y=None,
                                T_prime_y=10, T_prime=0, overlap=1,
                                eta=0.0,
                                denoising_steps=1000, reg_coef_pa = 1e4, reg_coef_ar = 1e4,
...
def MRSM_sample_2d_ISS_2dsound_res(config, net, sde, y, transform, corrector, n_steps=5, alpha=1., beta=0.4, gamma=0.5, snr=0.128, std_y=None,
                                T_prime_y=10, T_prime=0, overlap=1,
                                eta=0.0,
                                denoising_steps=1000, reg_coef_pa = 1e4, reg_coef_ar = 1e4,
                                use_residual_objective=False,
...
def calculate_physics_residual_loss_1d_4(data, c=343.0, rho0=1.21, dt=2e-4, dx=1/21, smooth=True):
    ...
    if smooth:
        ...
        b, t, ch, h = data.shape
        data_reshaped = data.view(b * t, ch, h)
...
def MRSM_sample_1d_ISS_1dtube_res(config, net, sde, y, transform, corrector, n_steps=5, alpha=1., beta=0.4, gamma=0.5, snr=0.128, std_y=None,
                                T_prime_y=10, T_prime=0, overlap=1,
                                eta=0.0,
...
def MRSM_sample_1d_ISS_1dtube_res_p(config, net, sde, y, transform, corrector, n_steps=5, alpha=1., beta=0.4, gamma=0.5, snr=0.128, std_y=None,
                                T_prime_y=10, T_prime=0, overlap=1,
                                eta=0.0,
                                denoising_steps=100, reg_coef_pa = 1e4, reg_coef_ar = 1e4,
                                use_residual_objective=False,
...
def MRSM_sample_2d_ISS_kol(config, net, sde, y, transform, corrector, n_steps=5, alpha=1., beta=0.4, gamma=0.5, snr=0.128, std_y=None,
                                T_prime_y=10, T_prime=0, overlap=1,
                                eta=0.0,
                                denoising_steps=1000, reg_coef_pa = 1e4, reg_coef_ar = 1e4,
                                use_residual_objective=False,
...
def MRSM_sample_2d_ISS_kol_martingale(config, net, sde, y, transform, corrector, n_steps=5, alpha=1., beta=0.4, gamma=0.5, snr=0.128, std_y=None,
                                T_prime_y=10, T_prime=0, overlap=1,
                                eta=0.0,
                                denoising_steps=1000, reg_coef_pa = 1e4, reg_coef_ar = 1e4,
                                use_residual_objective=False,
...
def MRSM_sample_1d_line_array_puvw(config, net, sde, y, transform, corrector, n_steps=5, 
                              alpha=1., beta1=100., beta2=100, snr=0.128, std_y=None, 
                              gamma=1.e-2, num_steps=10,  
                              denoising_steps=100, 
                              overlap=1, eta=0.0, reg_coef_pa = 1e4,
    ...
    def x_to_sample(xx, sample=None):
        ...
        for i in range(b):
            ...
            t_start = i_inv * (nf - ol)
            t_end = t_start + nf
            if t_end > ns_real: t_end = ns_real 
